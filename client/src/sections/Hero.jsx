                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <h1 className="text-4xl md:text-7xl xl:text-8xl 
                        ...
                        <span className="text-transparent bg-clip-text 
                            bg-gradient-to-r from-[#0D66BA] via-[#44BBDB] to-[#1CB48D]">
                    ...
                    {/* Dashboard Preview */}
                    <div className="mt-20 relative w-full max-w-6xl mx-auto group">
                        
                        <div className="absolute -inset-1 
                            bg-gradient-to-r from-[#44BBDB] via-[#1CB48D] to-[#0D66BA] 
                            rounded-3xl blur-lg opacity-25 
                        ...
                        <div className="hidden md:block absolute -bottom-12 -left-12 
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-[#1CB48D]">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
                                <div className="text-left">
                                    <p className="text-[11px] text-gray-400 font-bold uppercase tracking-wider">Delivery Rate</p>
                                    <p className="text-xl font-extrabold text-slate-900">99.99%</p>
                                </div>
                            </div>
                        </div>
                    </div>
